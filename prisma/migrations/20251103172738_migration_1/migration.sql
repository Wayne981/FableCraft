-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ARTISAN', 'BUYER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Story_productId_key" ON "Story"("productId");
...
-- AddForeignKey
ALTER TABLE "Story" ADD CONSTRAINT "Story_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
